 ...
 <x-frontend.layout.master>
	<x-slot name="title">AboutUs</x-slot>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{ asset('frontend/img/nstu.jpg') }}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <div class="container">
              <h4>
                The Institute of Information Technology (IIT) at Noakhali Science and Technology University (NSTU) was established with the goal of creating expert software engineers. The institute focuses on providing specialized education and training in the field of information technology and software development.
  
  The curriculum of the Institute of Information Technology is designed to equip students with the necessary knowledge and skills to excel in the rapidly evolving field of software engineering. It combines theoretical knowledge with practical hands-on experience to ensure that students are well-prepared for the challenges of the industry.
              </h4>
            </div>
