...
<header id="header" class="fixed-top">
  <div class="container d-flex align-items-center">
    ...
    <nav id="navbar" class="ms-auto navbar order-last order-lg-0">
      <ul>
        ...
        <li class="dropdown">
          ...
          <a href="#">
            <img src="{{asset('storage/profiles/'.auth()->user()->profile->image)}}" alt="profile"
              style="border-radius: 50%;width:35px;height:35px;" class="border" />
          ...
          <ul>
            ...
            <li>
              <form method="POST" action="{{ route('logout') }}">
                @csrf
                <a class="dropdown-itembtn" onclick="event.preventDefault();
        ...
        <a href="{{ route('login') }}" class="btn btn-outline-danger ms-3 shadow btn-sm p-1"><i
            class="fa-solid fa-right-to-bracket fa-shake me-2"></i>Login</a>
